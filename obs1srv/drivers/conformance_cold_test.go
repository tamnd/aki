...
func spinDemote(t *testing.T, rc *conformance.Conn) {
	...
	for i := 0; i < 50; i++ {
		...
		doStep(t, rc, []string{"EXISTS", conformance.ColdStreamKey})
	}
}
...
func TestConformanceCold(t *testing.T) {
	...
	want := []string{conformance.ColdHashKey, conformance.ColdSetKey, conformance.ColdZsetKey, conformance.ColdListKey, conformance.ColdStreamKey}
