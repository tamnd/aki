...
// TestSubkeyThroughEnvelope closes the loop with the record codec: a
// seg record built from an encoded subkey roundtrips and the decoded
// key parses back to the same subkey.
