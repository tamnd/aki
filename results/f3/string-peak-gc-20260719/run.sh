...
start(){ case $1 in
  reactor) GOGC=10 GOMAXPROCS=14 taskset -c $SMASK "$BIN" -addr 127.0.0.1:$PORT -shards 8 -arena-mib 512 -batch-data-cap 1024 -reply-ring 128 -free-list-cap 8 -net reactor -net-loops 0 >"$RAW/$1.log" 2>&1 & ;;
